...
//чтобы данные условия выполнялись, после добавления элемента в дерево необходимо произвести балансировку,
...
public class LeftTree<T extends Comparable<T>> {

    private Node root;


    /**
     * первичное добавление, когда дерево пустое
     * @param value
     * @return
     */
    ...
    /**
     * методы для печати сбалансированного дерева
     */
    public void print() {
